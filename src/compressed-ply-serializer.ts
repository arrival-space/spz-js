 ...
 */
export function serializeCompressedPly(data: GaussianCloud): Uint8Array {
...
function sortSplats(data: GaussianCloud, indices: number[]): void {
...
class SingleSplat {
    ...
    read(cloud: GaussianCloud, i: number) {
...
class Chunk {
    ...
    data: {
        ...
        y: Float32Array;
        z: Float32Array;
        scale_0: Float32Array;
        scale_1: Float32Array;
        scale_2: Float32Array;
        rot_0: Float32Array;
        rot_1: Float32Array;
        rot_2: Float32Array;
        rot_3: Float32Array;
