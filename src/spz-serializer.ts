...
export async function serializePackedGaussians(packed: PackedGaussians): Promise<Uint8Array> {
    const headerSize = 16;
...
export async function serializeSpz(g: GaussianCloud): Promise<Uint8Array> {
